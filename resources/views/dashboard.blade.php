                        ...
                        <div>
                            <div class="relative aspect-square rounded-full size-32 flex border mx-auto dark:bg-white/5 dark:border-white/10 before:absolute before:-inset-2 before:border dark:before:border-white/5 dark:before:bg-white/5 before:rounded-full">
                                <svg class="w-24 m-auto h-fit" viewBox="0 0 212 143" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <path class="text-blue-600 dark:text-blue-500" d="M3 72H209" stroke="currentColor" stroke-width="6" stroke-linecap="round"></path>
                                    <defs>
                                    ...
                                    <stop class="text-blue-600 dark:text-blue-500" offset="1" stop-color="currentColor"></stop>
                                    </linearGradient>
                                    <clipPath id="clip0_0_1">
                                    <rect width="129" height="72" fill="white" style="fill:white;fill-opacity:1;" transform="translate(41)"></rect>
                                    </clipPath>
                                    </defs>
                                </svg>
                            </div>
                        ...
                        <div>
                            <div class="pt-6 lg:px-6">
                                <svg class="w-full" viewBox="0 0 386 123" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <path fill-rule="evenodd" clip-rule="evenodd" d="M3 123C3 123 14.3298 94.153 35.1282 88.0957C55.9266 82.0384 65.9333 80.5508 65.9333 80.5508C65.9333 80.5508 80.699 80.5508 92.1777 80.5508C103.656 80.5508 100.887 63.5348 109.06 63.5348C117.233 63.5348 117.217 91.9728 124.78 91.9728C132.343 91.9728 142.264 78.03 153.831 80.5508C165.398 83.0716 186.825 91.9728 193.761 91.9728C200.697 91.9728 206.296 63.5348 214.07 63.5348C221.844 63.5348 238.653 93.7771 244.234 91.9728C249.814 90.1684 258.8 60 266.19 60C272.075 60 284.1 88.057 286.678 88.0957C294.762 88.2171 300.192 72.9284 305.423 72.9284C312.323 72.9284 323.377 65.2437 335.553 63.5348C347.729 61.8259 348.218 82.07 363.639 80.5508C367.875 80.1335 372.949 82.2017 376.437 87.1008C379.446 91.3274 381.054 97.4325 382.521 104.647C383.479 109.364 382.521 123 382.521 123" fill="url(#paint0_linear_0_106)" style=""></path>
                                    ...
                                    <defs>
                                        ...
                                        <clipPath id="clip0_0_106">
                                            <rect width="358" height="30" fill="white" style="fill:white;fill-opacity:1;" transform="translate(14 14)"></rect>
                                        </clipPath>
                                    </defs>
                                </svg>
                            </div>
