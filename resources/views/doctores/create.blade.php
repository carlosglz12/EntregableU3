...
@section('content')
<form class="custom-form" method="POST" action="{{ route('doctores.store') }}">
    @csrf
    ...
    <div class="form-group">
        <div class="form-item mb-5">
            ...
            <input type="text" id="especialidad" name="especialidad" placeholder="" required />
        </div>
        <div class="form-item mb-5">
            <label for="consultorio">Consultorio</label>
            <input type="number" id="consultorio" name="consultorio" placeholder="" required />
        </div>
    </div>   
